...
SELECT a.data_hora_inicio, pac.nome AS paciente, prof.nome AS fisioterapeuta,s.numero_sala
FROM agendamento a
...
SELECT 'conflito_fisioterapeuta' AS tipo, a1.id_agendamento AS agendamento_1, a2.id_agendamento AS agendamento_2
FROM agendamento a1
JOIN agendamento a2
